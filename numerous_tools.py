...
@tool 
def create_file(file_name: str, text: str, format_type: str) -> str:
...
def main():
    while True:
        ...
        format_type = input("Specify output format (PDF, TXT, CSV): ")
        ...
        try:
            ...
            # Call the create_file tool to generate the specified output file
            file_status = create_file.invoke({"file_name": file_name, "text": text_output, "format_type": format_type})
            print(file_status)
